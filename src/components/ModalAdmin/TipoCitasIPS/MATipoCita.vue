<template>
  <div
    class="modal fade"
    id="modalAdminTipoCita"
    tabindex="-1"
    aria-labelledby="modalAdminTipoCitaLabel"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div id="headerm-general" class="modal-header">
          <h1 class="modal-title fs-5" id="MAdmin">Administrar Tipo Cita</h1>
          <button
            type="button"
            id="closem-general"
  ...
  setup() {
    ...
    onMounted(() => {
      modalInstance.value = new Modal(
        document.getElementById("modalAdminTipoCita")
      );
    });
